...
public class TestLTMDeserializerIgnoreInclude extends AbstractValidCXTMTestCase {

    public TestLTMDeserializerIgnoreInclude(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
        super(file, inputDir, referenceDir, convertToTMDM);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findCXTMTests("ltm", "/various/cxtm/ignoreinclude/ltm/");
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        deser.setProperty(Property.IGNORE_INCLUDE, Boolean.TRUE);
        return deser;
    }
