...
public class TestLTMDeserializer extends AbstractValidCXTMTestCase {

    public TestLTMDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
