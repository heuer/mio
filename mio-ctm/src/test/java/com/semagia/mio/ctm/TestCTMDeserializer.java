...
public class TestCTMDeserializer extends AbstractValidCXTMTestCase {

    public TestCTMDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
