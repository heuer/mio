...
/**
 * Tests against the {@link NTriplesDeserializer}.
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 473 $ - $Date: 2010-09-08 13:36:04 +0200 (Mi, 08 Sep 2010) $
 */
@RunWith(Parameterized.class)
public class TestNTriplesDeserializer extends AbstractValidCXTMTestCase {

    public TestNTriplesDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        return new NTriplesDeserializerFactory().createDeserializer();
    }
