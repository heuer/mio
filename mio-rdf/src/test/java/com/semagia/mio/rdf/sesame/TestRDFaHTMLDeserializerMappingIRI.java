 ...
 * @version $Rev: 535 $ - $Date: 2010-09-17 01:19:54 +0200 (Fr, 17 Sep 2010) $
 */
@RunWith(Parameterized.class)
public class TestRDFaHTMLDeserializerMappingIRI extends AbstractValidCXTMTestCase {

    public TestRDFaHTMLDeserializerMappingIRI(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
        super(file, inputDir, referenceDir, convertToTMDM);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findCXTMTests("html", "/cxtm/rdf/");
    }
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestRDFaHTMLDeserializerMappingIRI.class.getResource("/cxtm/rdf/externalmapping/rdfa-mapping.rdf");
