...
public class TestRDFXMLDeserializerMappingProperty extends AbstractValidCXTMTestCase {

    public TestRDFXMLDeserializerMappingProperty(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
        super(file, inputDir, referenceDir, convertToTMDM);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findCXTMTests("rdf", "/cxtm/rdf/externalmapping/");
    }
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestRDFXMLDeserializerMappingProperty.class.getResource("/cxtm/rdf/externalmapping/foaf-mapping.rdf");
