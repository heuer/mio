...
public class TestN3DeserializerMappingProperty extends AbstractValidCXTMTestCase {

    public TestN3DeserializerMappingProperty(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestN3DeserializerMappingProperty.class.getResource("/cxtm/rdf/externalmapping/foaf-mapping.rdf");
