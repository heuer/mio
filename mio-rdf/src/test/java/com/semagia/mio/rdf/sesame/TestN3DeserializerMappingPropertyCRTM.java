...
public class TestN3DeserializerMappingPropertyCRTM extends AbstractValidCXTMTestCase {

    public TestN3DeserializerMappingPropertyCRTM(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
        super(file, inputDir, referenceDir, convertToTMDM);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findCXTMTests("n3", "/cxtm/rdf/crtm/");
    }
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestN3DeserializerMappingPropertyCRTM.class.getResource("/cxtm/rdf/crtm/mapping.crtm");
