...
/**
 * Tests against the {@link TrixDeserializer}.
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 564 $ - $Date: 2010-09-28 12:11:49 +0200 (Di, 28 Sep 2010) $
 */
@RunWith(Parameterized.class)
public class TestTrixDeserializer extends AbstractValidCXTMTestCase {

    public TestTrixDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
        super(file, inputDir, referenceDir, convertToTMDM);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findCXTMTests("trix", "/cxtm/rdf/");
    }
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        return new TrixDeserializerFactory().createDeserializer();
    }
