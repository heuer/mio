...
public class TestN3Deserializer extends AbstractValidCXTMTestCase {

    public TestN3Deserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        return new N3DeserializerFactory().createDeserializer();
    }
