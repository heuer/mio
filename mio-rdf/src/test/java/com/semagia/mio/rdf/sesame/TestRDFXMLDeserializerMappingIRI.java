...
public class TestRDFXMLDeserializerMappingIRI extends AbstractValidCXTMTestCase {

    public TestRDFXMLDeserializerMappingIRI(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestRDFXMLDeserializerMappingIRI.class.getResource("/cxtm/rdf/externalmapping/foaf-mapping.rdf");
