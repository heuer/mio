...
public class TestRDFXMLDeserializer extends AbstractValidCXTMTestCase {

    public TestRDFXMLDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
