...
public class TestN3DeserializerMappingIRICRTM extends AbstractValidCXTMTestCase {

    public TestN3DeserializerMappingIRICRTM(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestN3DeserializerMappingIRICRTM.class.getResource("/cxtm/rdf/crtm/mapping.crtm");
