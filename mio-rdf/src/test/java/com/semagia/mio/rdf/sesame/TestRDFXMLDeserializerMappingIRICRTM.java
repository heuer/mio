...
public class TestRDFXMLDeserializerMappingIRICRTM extends AbstractValidCXTMTestCase {

    public TestRDFXMLDeserializerMappingIRICRTM(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    protected IDeserializer makeDeserializer() throws Exception {
        ...
        final URL url = TestRDFXMLDeserializerMappingIRICRTM.class.getResource("/cxtm/rdf/crtm/mapping.crtm");
