...
/**
 * Tests against the {@link TMXML10Deserializer}.
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 467 $ - $Date: 2010-09-08 12:17:40 +0200 (Mi, 08 Sep 2010) $
 */
@RunWith(Parameterized.class)
public class TestTMXMLDeserializerInvalid extends AbstractInvalidCXTMTestCase {

    public TestTMXMLDeserializerInvalid(File file) {
        super(file);
    }
