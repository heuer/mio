...
/**
 * Tests against the {@link TMXMLDeserializer} (validating mode).
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 467 $ - $Date: 2010-09-08 12:17:40 +0200 (Mi, 08 Sep 2010) $
 */
public class TestTMXMLValidatingDeserializer extends TestTMXMLDeserializer {

    public TestTMXMLValidatingDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
