...
public class TestSnelloDeserializerInvalid extends AbstractInvalidCXTMTestCase {

    public TestSnelloDeserializerInvalid(File file) {
        super(file);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findInvalidCXTMTests("stm", "/cxtm/snello/");
    }
