...
/**
 * Implementation of the "ako" template
 * <p>
 * Creates a supertype-subtype relationship between two topics.
 * </p>
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 469 $ - $Date: 2010-09-08 12:39:06 +0200 (Mi, 08 Sep 2010) $
 */
final class TemplateAKO implements ITemplate {

    private static final String[] _PARAMS = new String[] {"subtype", "supertype"};

    /* (non-Javadoc)
     * @see com.semagia.mio.stm.dm.ITemplate#execute(com.semagia.mio.helpers.SimpleMapHandler, com.semagia.mio.stm.dm.IContext)
     */
    @Override
    public void execute(final SimpleMapHandler handler, IContext ctx) throws MIOException {
        handler.ako(ctx.getTopicReference(_PARAMS[0]), ctx.getTopicReference(_PARAMS[1]));
    }
