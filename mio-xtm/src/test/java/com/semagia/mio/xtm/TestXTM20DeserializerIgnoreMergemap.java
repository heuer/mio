...
public class TestXTM20DeserializerIgnoreMergemap extends AbstractValidCXTMTestCase {

    public TestXTM20DeserializerIgnoreMergemap(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
        super(file, inputDir, referenceDir, convertToTMDM);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return Filter.from("/various/cxtm/ignoremergemap/xtm2/")
                      .using("xtm")
                      .filter();
    }
