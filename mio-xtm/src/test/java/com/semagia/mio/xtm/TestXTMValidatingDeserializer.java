...
/**
 * Tests against the {@link XTMDeserializer} (validating mode).
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 462 $ - $Date: 2010-09-08 01:20:13 +0200 (Mi, 08 Sep 2010) $
 */
public class TestXTMValidatingDeserializer extends TestXTMDeserializer {

    public TestXTMValidatingDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
    ...
    public static Collection<Object> makeTestCases() {
        ...
        result.addAll(TestXTM10ValidatingDeserializer.makeTestCases());
        result.addAll(TestXTM21ValidatingDeserializer.makeTestCases());
        return result;
    }
