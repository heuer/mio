...
/**
 * Tests against the {@link XTM20Deserializer} (validating mode).
 * 
 * @author Lars Heuer (heuer[at]semagia.com) <a href="http://www.semagia.com/">Semagia</a>
 * @version $Rev: 462 $ - $Date: 2010-09-08 01:20:13 +0200 (Mi, 08 Sep 2010) $
 */
public class TestXTM20ValidatingDeserializer extends TestXTM20Deserializer {

    public TestXTM20ValidatingDeserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
