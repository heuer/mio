...
public class TestXTM21ValidatingDeserializerInvalid extends AbstractInvalidCXTMTestCase {

    public TestXTM21ValidatingDeserializerInvalid(File file) {
        super(file);
    }

    @Parameters
    public static Collection<Object> makeTestCases() {
        return CXTMTestUtils.findInvalidCXTMTests("xtm", "/cxtm/xtm2/", "/cxtm/xtm21/");
      
    }

    @Override
    protected IDeserializer makeDeserializer() throws Exception {
        final IDeserializer deser = new XTM21DeserializerFactory().createDeserializer();
