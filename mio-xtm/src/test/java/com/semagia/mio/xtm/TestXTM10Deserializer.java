...
public class TestXTM10Deserializer extends AbstractValidCXTMTestCase {

    public TestXTM10Deserializer(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
